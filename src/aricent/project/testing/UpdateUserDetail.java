...
public class UpdateUserDetail {
	...
	@BeforeClass public static void addUsers()
	{
	...
	public void updateDetails()
	{
		...
		int val=user.updateDetails(ph.getUserID(), "shyam", "7878974465", "address", "city", "state", "524113");
		assertEquals(1, val);
	}
	@Test
	...
	@AfterClass public static void deleteAgents()
	{
