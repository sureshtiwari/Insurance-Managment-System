...
<body>
	...
	%><center>
		<form action="AgentRequestHandler" method="post" onsubmit="return updateValidate(document.getElementById('name').value,document.getElementById('number').value,document.getElementById('address').value,document.getElementById('city').value,document.getElementById('state').value,document.getElementById('zip').value)">
			<table width="250px" style="text-align: left;">
				<input type="hidden" name="action" value="updatePersonelDetails">
				<tr>
				...
				<tr>
					<td><b>Zip Code :</b></td>
					<td><input type="text" name="zip" align="left" id="zip" onblur="zipValidate(document.getElementById('zip').value)"
						value="<%=list.get(8)%>"></td>
					<td><span class="glyphicon glyphicon-pencil"></span></td>
				</tr>
